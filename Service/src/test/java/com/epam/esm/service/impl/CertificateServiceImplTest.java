...
public class CertificateServiceImplTest {
    ...
    public void init(){
        ...
        when(certificateDao.create("Existing", "Existing",10,
                10, new ArrayList<>())).thenReturn(Optional.empty());
        when(certificateDao.create("NotExisting", "NotExisting",11,
                11, new ArrayList<>())).thenReturn(Optional.of(new GiftCertificate()));
    ...
    public void createFailTest(){
        ...
        boolean result = certificateService.create(certificateCreateDTO).isPresent();
        assertFalse(result);
    }
